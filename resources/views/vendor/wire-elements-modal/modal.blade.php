<div>
    ...
    <div x-data="LivewireUIModal()" x-init="init()" x-on:close.stop="setShowPropertyTo(false)"
        ...
        class="fixed inset-0 z-[51] overflow-y-auto" style="display: none;">
        <div
            class="flex min-h-screen items-center justify-center px-4 pb-10 pt-4 text-center sm:block sm:p-0">
            ...
            <div x-show="show && showActiveComponent" x-transition:enter="ease-out duration-300"
                ...
                id="modal-container" x-trap.noscroll.inert="show && showActiveComponent"
                aria-modal="true">
