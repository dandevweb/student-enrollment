            ...
            <div class="p-6 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h2 class="text-base font-semibold leading-6 text-gray-900">Matrículas</h2>
                        <p class="mt-2 text-sm text-gray-700">Selecione uma série para realizar as
                            matrículas</p>
                    </div>
            ...
            <div class="py-12 overflow-auto">
                <div>
                    <div class="max-w-xl mb-4">
                        <label for="grade"
                            class="block text-sm font-medium text-gray-700">Selecionar
                            Série</label>
